...
"""
GIANT DISCLAIMER: THE DEFINITIONS IN THIS FILE ARE USED EXACTLY AS  IN
https://github.com/JJGO/shrinkbench/blob/master/pruning/modules.py
for a complete visit the github https://github.com/JJGO/shrinkbench
"""
