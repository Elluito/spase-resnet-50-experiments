...
class ResNet(nn.Module):
    ...
    def apply_masks(self):
        ...
        # TODO: Find out if I need to use torch.no_grad()
        for name,param in self.named_parameters():
            if name in self.masks.keys():
                param.data = torch.multiply(param.data,self.masks[name].cuda().data)
    def forward(self, x):
...
def resnet18():
    ...
    """
    return ResNet(BasicBlock, [2, 2, 2, 2],name="18")
...
def resnet34():
    ...
    """
    return ResNet(BasicBlock, [3, 4, 6, 3],name="34")
...
def resnet50(num_classes):
    ...
    """
    return ResNet(BottleNeck, [3, 4, 6, 3], num_classes=num_classes,name="50")
...
def resnet101():
    ...
    """
    return ResNet(BottleNeck, [3, 4, 23, 3],name="101")
...
def resnet152():
    ...
    """
    return ResNet(BottleNeck, [3, 8, 36, 3],name="152")
